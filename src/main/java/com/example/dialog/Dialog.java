...
public class Dialog {
    public static void main(String[] args) {
        ...
        System.out.println("So you are " + old + "! That is " + old*12 + " months, or " + old*12*29.3 + " days, hehe");
        System.out.println("I am just a code but forgot to ask you to input you surname, so type it in chat please:");
        ...
        System.out.print("You have been graduated from school in " + year + ". Your favorite activity is " + activity + " " + n );
    }
}
